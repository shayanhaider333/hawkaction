                             ...
                             <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        <input type="number" id="cell" value="" style="display: none;">
                                    </div>
                                </div>
                            </div>
                            <!-- ============================================================== -->
                ...
                $.ajax({
                    ...
                    success:function(data){
                        ...
                        if(data1 != null)
                        {
                            ...
                            cell = $('#cell').val(data1[1].id);
                            var status = "";

                            $.each(data1[0],function(key,value){
                                
                                if(value.status == 0){ status = "<a href='../admin/approve/"+value.id+"' class='status-eye-0 font-tags'><i class='fa fa-eye' aria-hidden='true'></i></a>"}
