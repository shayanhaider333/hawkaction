                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            <li class="nav-item" style="">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-10" aria-controls="submenu-10"><i class="fas fa-f fa-bars" style="margin-top: -3px;"></i>Menu</a>
                                <div id="submenu-10" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{url('/admin/profile')}}"><i class="fas fa-fw fa-file-alt"></i>Profile</a> 
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{url('/admin/new-report')}}"><i class="fas fa-fw fa-file-alt"></i>New Report</a> 
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{url('/admin/video-request')}}"><i class="fas fa-fw fa-video"></i>Video Requests</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{url('/admin/store')}}"><i class="fas fa-fw fa-warehouse"></i>Store</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{url('/admin/printing')}}"><i class="fas fa-fw fa-print"></i>Bulk Printing</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                <form action="" enctype="multipart/form-data" id="filter_form">
                                    ...
                                    <div class="row">
                                        <label class="pl-3 pt-3">Client</label>
                                    </div>
                                    <div class="row">
                                        <select class="selectpicker pl-3 pt-1 mutlidrop"  data-live-search="true" id="user" name="user">
                                ...
                                <h1 style="font-size:36px; color:#0e0c28;">Hawkaction</h1>
                                <h1 style="font-size:36px;color:#0e0c28;">Hawkaction</h1>
                                <h1 style="font-size:36px;color:#0e0c28;">Hawkaction</h1>
                                <h1 style="font-size:36px;color:#0e0c28;">Hawkaction</h1>
                                <h1 style="font-size:36px;color:#0e0c28;">Hawkaction</h1>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $('#user').on('change',function(){
                ...
                $.ajax({
                    url:"../admin/filter-getstore/"+user,
                    type:"GET",
                    datatype:'json',
                    success:function(data)
                    {   
                        ...
                        {
                            $('#store').empty();
                            $('#store').appendTo("<option value='"+data.id+"'>"+data.store_name+"</option>");
                    ...
                    error:function()
                    {
                        console.log('Error in onchange user');
                    }
                });
            ...
            $('#store').on('change',function(){
                ...
                $.ajax({
                    url:"../admin/filter-getcamera/"+store,
                    type:"GET",
                    datatype:'json',
                    success:function(data)
                    {
