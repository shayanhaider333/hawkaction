...
<body>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            ...
                                            <form action="" id="doc_form" enctype="multipart/form-data" data-parsley-validate="" novalidate="" method="POST">
                                                @csrf
                                                <input type="text" name="rep_id" value="{{$result[0]->id}}" style="display: none" > 
                                                <div class="form-group">
                                                    
                                                    <input id="doc" name="doc" type="file" multiple="false" class="form-control"  required="" accept=".xlsx,.xls,.doc,.docx,.pdf">
                                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                ...
                                                <div class="bar m-3 "></div>
                                                    <form id="link_form" name="link_form" data-parsley-validate="" novalidate="" method="POST">
                                                        @csrf
                                                        <input type="text" name="rep_id2" value="{{$result[0]->id}}" style="display: none" > 
                                                        <div class="row">
                                                        <div class="col-md-2 p-2">
                                                            <label>Video Link : </label>
                                                        </div>
                                                        <div class="col-md-8 form-group">
                                                            <input type="text" id="video_link" name="video_link" class="form-control"  value="@if($result[0]->link != null) {{$result[0]->link}} @endif" required="">
                                                        </div>
                                                        <div class="col-md-2">
                                                            <p class="text-right">
                                                                <button type="submit" class="btn btn-space btn-primary">Upload Link</button>
                                                            </p>
                                                        </div>
                                                        </div>
                                                    </form>
    ...
    <script type="text/javascript">
        ...
        function del(id)
        {
                ...
                type:'GET',
                url:'{{route("delete-admin-comment")}}',
                data:{'id':id},
                datatype:'json',
                success:function(data)
                {   
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            e.preventDefault();
                ...
                if($('#video_link').val().length !== 0 && $('#video_link').val().substring(0,4) == 'http')
                {
                    $.ajax({
                        type:'POST',
                        url:'{{route("link")}}',
                        ...
                        success: function(data){
                            ...
                            alert("Link Successfully Uploaded");
