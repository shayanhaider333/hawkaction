                                                ...
                                                <div id="report" class="container">
                                                    <div class="row report-detail">
                                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                            <div class="row"><label>Client ID : {{$info->id}}</label></div>
                                                            <div class="row"><label>Name : {{$info->name}} </label></div>
                                                            <div class="row"><label>Email : {{ $info->email }} </label></div>
                                                            <div class="row"><label>Phone : {{ $info->phone }}</label></div> 
                                                            <div class="row"><label>Address : {{ $info->address }}, {{ $info->city['city_name'] }}, {{ $info->state['state_name'] }}, {{ $info->country['country_name'] }}</label></div>                
                                                        </div>
                                                    </div>
                                                    <div class="row report-detail">
                                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" >
            ...
            <div class="modal fade" id="edit_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                  ...
                  <form id="info_form" method="post" action="{{route('user-profile-edit')}}">
                    @csrf
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label>Phone</label>
                                <input id="phone" type="text" name="phone" data-parsley-trigger="change" value="{{$info->phone}}" required="" placeholder="" autocomplete="off" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Address</label>
                                <input id="address" type="text" name="address" data-parsley-trigger="change" value="{{$info->address}}" required="" placeholder="" autocomplete="off" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>City</label>
                                <select class="form-control  pl-3 pt-1 select2" id="city" name="city">
                                    <option value="{{$info->city['id']}}">{{$info->city['city_name']}}</option>
                            ...
                            <div class="form-group">
                                <label>State</label>
                                <select class="form-control pl-3 pt-1 select2" id="state" name="state">
                                    <option value="{{$info->state['id']}}">{{$info->state['state_name']}}</option>
            ...
            <div class="modal fade" id="password_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                  ...
                  <form id="password_form" method="post" action="{{route('user-reset-pass')}}">
                    @csrf
                    <div class="modal-body">
                        <div class="form-group">
